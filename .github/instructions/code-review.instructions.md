...
description: >
  ...
  actionable findings grounded in security-first thinking, maintainability,
  loose coupling, robustness, production-readiness, regression-safety,
  performance, and the KISS / SOLID / DRY / YAGNI design principles.
---
